...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Catalogos/Transportistas/Vehiculo/select_Seleccionar TransportistaUshipAusenc_0612e0'), 
    transportador, false, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Catalogos/Transportistas/Vehiculo/input_Poliza_policy'), poliza)
